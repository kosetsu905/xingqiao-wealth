...
public class AgencyCustomerController extends BaseController {
     ...
     */
    @PostMapping("/save")
    public R saveCustomer(@RequestBody AgencyEkyc.CustomerSaveRequest request) {
        try {
     ...
     */
    @GetMapping("/list")
    public TableDataInfo getList(AgencyEkyc.CustomerQueryRequest request) {
        Long employeeId = SecurityUtils.getUserId();
    ...
    public TableDataInfo getCustomerSalesList(AgencyEkyc.CustomerQueryRequest request) {
        Long employeeId = SecurityUtils.getUserId();
        request.setEmployeeId(employeeId);
        startPage();
    ...
    public R saveCustomerIntention(@RequestBody AgencyEkyc.CustomerSaleSaveRequest request) {
        try {
            Long userId = SecurityUtils.getUserId();
            request.setEmployeeId(userId);
    ...
    public R updateCustomerIntention(@RequestBody AgencyEkyc.CustomerSaleSaveRequest request) {
        try {
            Long userId = SecurityUtils.getUserId();
            request.setEmployeeId(userId);
    ...
    public R<List<CustomerListInnerResponse>> getCustomerInnerList(@RequestBody AgencyEkyc.CustomerQueryInnerRequest request) {
