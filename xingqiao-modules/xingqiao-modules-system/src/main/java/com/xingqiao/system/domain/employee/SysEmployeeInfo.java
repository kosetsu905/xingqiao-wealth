package com.xingqiao.system.domain.employee;
...
public class SysEmployeeInfo extends BaseEntity
{
    ...
    /** 账户名称（登录用） */
    @Excel(name = "账户名称", readConverterExp = "登=录用")
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("professionalExperience", getProfessionalExperience())
