...
public class SysCustomerInfoServiceImpl implements ISysCustomerInfoService
{
    ...
    @Override
    @Transactional
    public int saveCustomer(CustomerSaveRequest request) {
        ...
        // 保存投资偏好
        List<CustomerInvestmentPreference> requestReferences = request.getInvestmentPreferences();
        for (CustomerInvestmentPreference requestReference : requestReferences){
    ...
    public CustomerInfoResponse getCustomerInfo(Long employeeId, Long id) {
        ...
        if (CollectionUtils.isNotEmpty(preferences)){
            List<CustomerInvestmentPreference> customerInvestmentPreferences = preferences.stream().map(item -> {
                CustomerInvestmentPreference preference = new CustomerInvestmentPreference();
    ...
    public List<CustomerListResponse> getList(CustomerQueryRequest request) {
        ...
        Map<String, List<CustomerInvestmentPreference>> preferencesMap = new HashMap<>();
        for (String userTempId : userTempIds) {
            ...
            List<CustomerInvestmentPreference> customerInvestmentPreferences =
    ...
    @Override
    public List<CustomerSaleListResponse> getCustomerSalesList(CustomerQueryRequest request) {
        // 1. 查询销售机会基础列表
    ...
    @Override
    public int saveCustomerIntention(CustomerSaleSaveRequest request) {
    ...
    @Transactional
    @Override
    public int updateCustomerIntention(CustomerSaleSaveRequest request) {
