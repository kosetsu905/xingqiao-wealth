...
public class QuoteController extends BaseController {
     ...
     * 获取股票行情
     */
    @PostMapping("/getStockCurrentQuote")
    public R<StockQuote> getStockCurrentQuote(@RequestBody QueryStockQuote queryStockQuote) {
        try {
            log.info("获取股票行情: stockCode={}", queryStockQuote.getStockCode());
            return quoteApiService.getStockCurrentQuote(queryStockQuote);
        } catch (Exception e) {
