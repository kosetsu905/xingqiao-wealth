package com.xingqiao.order.domain.system;
 ...
 * @date 2025-09-07
 */
public class CustomerInfoExt extends BaseEntity
{
    ...
    public void setFaceVerifyStatus(Long faceVerifyStatus)
    {
        this.faceVerifyStatus = faceVerifyStatus;
    }

    public Long getFaceVerifyStatus()
    {
    ...
    {
        return faceVerifyTime;
    }

    public void setFaceVerifyScore(BigDecimal faceVerifyScore)
    {
        this.faceVerifyScore = faceVerifyScore;
    }

    public BigDecimal getFaceVerifyScore()
    {
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
                ...
                .append("certifyId", getCertifyId())
                .append("faceVerifyStatus", getFaceVerifyStatus())
                .append("faceVerifyTime", getFaceVerifyTime())
                .append("faceVerifyScore", getFaceVerifyScore())
