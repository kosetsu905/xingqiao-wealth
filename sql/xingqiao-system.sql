...
DROP DATABASE IF EXISTS `xingqiao-system`;

CREATE DATABASE  `xingqiao-system` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
insert into sys_menu values('4', '若依官网', '0', '4', 'http://xingqiao.vip', null, '', '', 0, 0, 'M', '0', '0', '', 'guide',    'admin', sysdate(), '', null, '若依官网地址');
-- 二级菜单
